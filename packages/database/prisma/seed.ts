...
const components = [
  ...
  },
  {
    ...
    categoryKey: "MOTHERBOARD",
    brandName: "MSI",
    model: "MAG B760M MORTAR WIFI",
    price: "179.00",
    description: "Micro-ATX LGA1700 motherboard with DDR5 and WiFi 6E.",
    specifications: {
      socket: "LGA1700",
      chipset: "B760",
      ...
      dimensionsMm: { width: 244, depth: 244 },
    },
    generator: "createGenericMotherboard",
  },
  {
    sku: "GPU-ASUS-RTX4090",
    categoryKey: "GPU",
    brandName: "ASUS",
    model: "ROG STRIX GeForce RTX 4090 OC",
    price: "1999.00",
    description: "24GB flagship GPU; very long card, good for testing GPU clearance failures.",
    specifications: {
      gpuArchitecture: "Ada Lovelace",
      vramCapacityGb: 24,
      vramType: "GDDR6X",
      ...
      rayTracingSupport: true,
      dlss: "DLSS 3",
      displayOutputs: ["3x DisplayPort 1.4a", "2x HDMI 2.1"],
      lengthMm: 358,
      widthMm: 150,
      heightMm: 72,
      slotWidth: 3.65,
  ...
  {
    sku: "RAM-CORSAIR-VENGEANCE-16GB-DDR4",
    categoryKey: "RAM",
    brandName: "Corsair",
    model: "Vengeance LPX DDR4-3200 16GB (2x8GB)",
    price: "42.00",
    description: "DDR4 kit, useful for testing RAM type mismatch against DDR5 boards.",
    specifications: {
      memoryCapacityGb: 16,
      numberOfModules: 2,
      memoryType: "DDR4",
  ...
  {
    sku: "PSU-CORSAIR-CV450",
    categoryKey: "PSU",
    brandName: "Corsair",
    model: "CV450",
    price: "49.00",
    description: "450W budget PSU, useful for testing insufficient-wattage warnings.",
    specifications: {
      wattage: 450,
      efficiencyCertification: "80 PLUS Bronze",
      modularType: "Non-Modular",
      formFactor: "ATX",
      atxStandard: "ATX 2.4",
      pciePowerConnectors: 2,
      cpuPowerConnectors: 1,
      sataConnectors: 5,
      molexConnectors: 3,
      fanSizeMm: 120,
      dimensionsMm: { length: 140 },
  ...
  },
  {
    ...
    model: "H1 V2 (compact)",
    price: "349.00",
    description: "Small Mini-ITX-only case with a tight GPU limit, for testing form factor/clearance failures.",
    specifications: {
      caseType: "Mini-ITX",
      supportedMotherboardFormFactors: ["Mini-ITX"],
      maxGpuLengthMm: 305,
      ...
      driveBays: { "2.5in": 2 },
      frontIo: ["USB-C", "USB-A"],
      dimensionsMm: { height: 386, width: 187, depth: 187 },
      glassPanels: 1,
      rgbSupport: false,
      includedFans: 1,
    },
  ...
  },
  {
    ...
    generator: "createGenericSSD",
  },
  {
    sku: "SSD-SAMSUNG-870EVO-500GB",
    categoryKey: "SSD",
    brandName: "Samsung",
    model: "870 EVO 500GB",
    price: "54.00",
    description: "500GB SATA 2.5\" SSD.",
    specifications: {
      capacityGb: 500,
      formFactor: "SATA 2.5\"",
      interface: "SATA III",
  ...
  },
  {
    ...
    categoryKey: "AIR_COOLER",
    brandName: "Noctua",
    model: "NH-D15",
    price: "109.00",
    description: "Dual-tower air cooler; tall, so it fails clearance in compact cases.",
    specifications: {
      coolerType: "Dual tower",
      heightMm: 165,
      fanSizeMm: 140,
      tdpRatingWatts: 250,
      socketCompatibility: ["AM5", "AM4", "LGA1700", "LGA1200"],
      dimensionsMm: { width: 150, depth: 135 },
    },
    generator: "createGenericAirCooler",
  },
  {
    sku: "AIO-CORSAIR-H150I-360",
    categoryKey: "AIO_COOLER",
    brandName: "Corsair",
    model: "iCUE H150i Elite 360mm",
    price: "189.00",
    ...
    specifications: {
      ...
      socketCompatibility: ["AM5", "AM4", "LGA1700", "LGA1200"],
      rgb: true,
      supportedMountingPositions: ["Front", "Top"],
    },
    generator: "createGenericAIO",
  },
  {
    sku: "FAN-NOCTUA-NF-A12X25",
    categoryKey: "FAN",
    brandName: "Noctua",
    model: "NF-A12x25 PWM",
    price: "34.00",
    description: "120mm PWM case fan.",
    specifications: {
      sizeMm: 120,
      thicknessMm: 25,
      rpm: 2000,
      ...
      powerConsumptionWatts: 1.68,
      bladeDirection: "Forward Blade",
    },
    generator: "createGenericFan",
  },
  {
    sku: "FAN-CORSAIR-LL120-REVERSE",
    categoryKey: "FAN",
    brandName: "Corsair",
    model: "iCUE LL120 RGB (reverse blade)",
    price: "29.00",
    description: "120mm RGB fan with reverse blades, for testing fan orientation later.",
    specifications: {
      sizeMm: 120,
      thicknessMm: 25,
      rpm: 1500,
  ...
  },
  {
    ...
    categoryKey: "MONITOR",
    brandName: "LG",
    model: "UltraGear 27GP850-B",
    price: "379.00",
    description: "27-inch 1440p 165Hz Nano IPS gaming monitor.",
    specifications: {
      screenSizeInches: 27,
    ...
    generator: "createGenericMonitor",
  },
  {
    sku: "LCD-NZXT-KRAKEN-LCD",
    categoryKey: "CASE_LCD",
    brandName: "NZXT",
    model: "Kraken 2.4in LCD Display",
    price: "79.00",
    description: "Small in-case LCD display panel.",
    specifications: {
      displaySizeInches: 2.4,
      resolution: "640x640",
      interface: "USB",
      refreshRateHz: 60,
      mountingType: "Pump cap",
      brightnessNits: 600,
    },
    generator: "createGenericCaseLcd",
  },
] as const;
